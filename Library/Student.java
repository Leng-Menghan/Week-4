...
public class Student extends User {
    ...
    public void StudentFeatures() {
        ...
        JPanel panelButton = GUI.createInputPanel(frame, 0, 60, 500, 170);

        JButton button1 = GUI.createButton("Display Book", 150, 0, 200, 40, panelButton);
        JButton button7 = GUI.createButton("Your Profile",  150, 50, 200, 40, panelButton);
        JButton button4 = GUI.createButton("Log out", 150, 100, 200, 40, panelButton);
    ...
    public void BorrowAction() {
        ...
        JButton BorrowButton = GUI.createButton("Borrow", 200, 83, 100, 30, panelInput); 
    ...
    public void DisplayInvoice(String bookId, String bookName, String studentId, String studentName, String librarianId,
            String Librarianname,String payment) {
        // Create frame
        ...
        JLabel Dates = new JLabel("Date: " + today + "  |  " + futureDate);
